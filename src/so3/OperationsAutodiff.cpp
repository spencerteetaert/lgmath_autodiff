...
Eigen::Matrix<AUTODIFF_VAR_TYPE, 3, 3> vec2rot(
  ...
  if (numTerms == 0) {
    ...
    const AUTODIFF_VAR_TYPE cosphi_ba = cos(phi_ba);
    return cosphi_ba * Eigen::Matrix<AUTODIFF_VAR_TYPE, 3, 3>::Identity() +
    ...
    Eigen::Matrix<AUTODIFF_VAR_TYPE, 3, 3> x_small = so3::diff::hat(aaxis_ba);
...
Eigen::Matrix<AUTODIFF_VAR_TYPE, 3, 3> vec2jac(
  ...
  if (numTerms == 0) {
    ...
    return sinTerm * Eigen::Matrix<AUTODIFF_VAR_TYPE, 3, 3>::Identity() +
...
Eigen::Matrix<AUTODIFF_VAR_TYPE, 3, 3> vec2jacinv(
  ...
  if (numTerms == 0) {
    ...
    return cotanTerm * Eigen::Matrix<AUTODIFF_VAR_TYPE, 3, 3>::Identity() +
